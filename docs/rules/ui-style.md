...
- 注音 ruby:**台灣課本式右側直欄**(2026-07-11 Sean 指示)— 符號 0.4em 直排於字右、聲調欄右中、輕聲欄頂;欄固定寬 0.55em 使字塊等寬、字距均勻;行高 1.6(右欄不佔上方空間)
- 注音範圍:**全部學生可見文字**的每個中文字都要標(題目、選項、首頁文案、按鈕、提示、結果頁 — Sean 2026-07-11 指示,推翻早前「chrome 不標」);提供注音顯示開關;互動元件以 aria-label 提供純文字可及名稱
